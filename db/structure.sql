...
--
-- Name: update_post_avg_rating(); Type: FUNCTION; Schema: public; Owner: -
--

CREATE FUNCTION public.update_post_avg_rating() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
   UPDATE posts SET
...
CREATE TABLE public.posts (
    ...
    ratings_sum bigint DEFAULT 0 NOT NULL,
...
--
-- Name: ratings after_ratings_insert; Type: TRIGGER; Schema: public; Owner: -
--

CREATE TRIGGER after_ratings_insert AFTER INSERT ON public.ratings FOR EACH ROW EXECUTE PROCEDURE public.update_post_avg_rating();
